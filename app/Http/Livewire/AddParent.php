...
class AddParent extends Component
{
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:14|max:14|regex:/[0-9]{13}/',
            'Passport_ID_Father' => 'required|string|min:9|max:9|regex:/[a-zA-Z0-9]{9}/',
            'Phone_Father' => 'regex:/^([0-9\s\-\+\(\)]*)$/|min:11',
            'National_ID_Mother' => 'required|string|min:14|max:14|regex:/[0-9]{13}/',
            'Passport_ID_Mother' => 'required|string|min:9|max:9|regex:/[a-zA-Z0-9]{9}/',
