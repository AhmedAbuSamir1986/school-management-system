                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                            ...
                            <thead>
                            <tr>
                                <th><input type="checkbox" name="select_all" id="example-select-all" onclick="ChechAll('box1', this)"></th>
                                <th>#</th>
                            ...
                            <tbody>
                            @if(isset($details))
                                <?php $List_calsses = $details; ?>
                            @else
                                <?php $List_calsses = $My_Classes; ?>
                            @endif
                            <?php $i = 0; ?>
                            @foreach ($List_calsses as $My_Class)
                                <tr>
                                    <?php $i++; ?>
